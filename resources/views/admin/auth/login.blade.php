...
<body class="login" style="background-image: url({{asset('assets/backend/img/office.jpg')}});background-size: cover;">
<br>
<br>
<br>
<br>
...
<div class="content" style="background-color: black">
    ...
    <form class="login-form"  method="POST" action="{{ route('admin.login') }}">
        {{ csrf_field() }}
        <h3 class="form-title">管理者 ログイン</h3>
        ...
        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <label class="control-label visible-ie8 visible-ie9">メール</label>
            <div class="input-icon">
                <i class="fa fa-user"></i>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="メール" name="email" />
                @if ($errors->has('email'))
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="パスワード" name="password" />
        ...
        <div class="form-actions">
            <label class="control-label">
                <input  type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}>  私を覚えてますか
            </label>
            <button type="submit" class="btn green-dark pull-right"> ログイン </button>
        </div>
...
<div class="copyright" style="color: black"></div>
