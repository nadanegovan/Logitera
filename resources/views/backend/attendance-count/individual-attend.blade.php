                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-medium date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                <input class="form-control" type="text" name="from_date" data-date-format="yyyy-mm-dd" id="from_date" placeholder="From Date" readonly />                                                 <span class="input-group-btn">
                                ...
                                {{--<div class="form-actions">--}}
                                    {{--<div class="row">--}}
                                        {{--<div class="col-md-2">--}}
                                            {{--<input type="button" name="filter" id="filter" value="Filter" class="btn btn-info" />                                          </div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            <!-- END FORM-->
